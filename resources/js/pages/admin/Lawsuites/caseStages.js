...
export default function caseStages({...others}){
    ...
    useEffect(()=>{
        dispatch({
            type: actions.GETCASESTAGES
        });
    },[]);

    useEffect(()=>{
        setRows(data.caseStagesData);
    });

    const [row, setRow] = useState();

    const [openAddNewStageLitigationModal, setOpenAddNewStageLitigationModal] = useState(false);
    const addNewStageLitigation = () => {
        setOpenAddNewStageLitigationModal(true);
    }
    const handleCloseAddNewStageLitigationModal = () => {
        setOpenAddNewStageLitigationModal(false);
    };
    ...
    return (
        <Index>
            <Box sx={{ bgcolor: 'background.paper', minHeight: '90vh' }}>
                    ...
                    <Grid container justifyContent="space-between">
                        <Grid item>
                            <Breadcrumbs aria-label="breadcrumb">
                                ...
                                <Typography> Stages Litigation </Typography>
                            </Breadcrumbs>
                        </Grid>
                        <Grid item style={{marginBottom: 10}}>
                            <Button size="small" variant="contained" color='primary' style={{marginRight: 10}} onClick={() => addNewStageLitigation()}>
                                Add new Stage Litigation
                                <AddIcon/>
                            </Button>
                        </Grid>
                    </Grid>
                ...
                <Box>
                    <Card xs={{display: 'flex'}} style={{padding: '20px 20px'}}>
                        ...
                        <Typography className='text-secondary'>
                            Here you can add or edit and all actions Stage Litigation...
                        </Typography>
                ...
                <Dialog
                    open={openAddNewStageLitigationModal}
                    onClose={handleCloseAddNewStageLitigationModal}
                ...
                >
                    ...
                    >
                        ...
                        <form noValidate onSubmit={handleSubmit} {...others}>
                                ...
                                <Grid container columns={{xs:2, sm:8, md:16}}>
                                    <Grid item xs={2} sm={8} md={16}>
                                        <FormControl fullWidth error={Boolean(touched.name && errors.name)} sx={{ ...theme.typography.customInput}}>
                                            <InputLabel htmlFor="outlined-adornment-case-lawsuite-name">Stage Name</InputLabel>
                                            <OutlinedInput
                            ...
                            <DialogActions>
                                <Button onClick={handleCloseAddNewStageLitigationModal}>Cancel</Button>
